...
export const createRoom = asyncHandler(async (req, res) => {
    ...
    return res
        .status(201)
        .json(new ApiResponse(201, room, "Room created"));
});
...
export const getAllRooms = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, rooms, "Rooms retrieved"));
});
...
export const deleteRoom = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, {}, "Room deleted"));
});
...
export const updateRoomCode = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, room, "Code saved"));
});